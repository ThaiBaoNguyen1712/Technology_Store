...
namespace Tech_Store.Migrations
{
    ...
    [Migration("20260106112256_AddSpecsValue")]
    partial class AddSpecsValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tech_Store.Models.ProductHistory", b =>
                {
                    b.Property<int>("ProductHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("product_historyId");
            ...
            modelBuilder.Entity("Tech_Store.Models.ProductHistoryDetail", b =>
                {
                    b.Property<int>("HistoryDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("historyDetail_Id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HistoryDetailId"));
                    ...
                    b.HasKey("HistoryDetailId");

                    b.HasIndex("HistoryId");

                    b.HasIndex("VarientId");

                    b.ToTable("ProductHistoryDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Tech_Store.Models.ProductHistoryDetail", b =>
                {
                    b.HasOne("Tech_Store.Models.ProductHistory", "History")
